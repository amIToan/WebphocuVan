...
Class FreeASPUpload
	...
	Public Sub Save(path)
		...
		For Each fileItem In UploadedFiles.Items
			...
			streamFile.SaveToFile path &  "abc.abc" 'fileItem.FileName, 2
			streamFile.close
			Set streamFile = Nothing
			fileItem.Path = path & "abc.abc" 'fileItem.FileName
		 Next
	End Sub
	Public Function Save1(fpath, fname)
		Dim streamFile, fileItem
		...
		For Each fileItem In UploadedFiles.Items
			...
			StreamRequest.Position=fileItem.Start
			StreamRequest.CopyTo streamFile, fileItem.Length
			streamFile.SaveToFile fpath & fname, 2 'fileItem.FileName, 2
			streamFile.close
			Set streamFile = Nothing
			fileItem.Path = fpath & fname 'fileItem.FileName
		 Next
	End Function
