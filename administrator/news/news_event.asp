...
<%
	...
	Title_This_Page="Tin t&#7913;c -> D&#242;ng s&#7921; ki&#7879;n"
...
<table width="770" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr align="right" valign="top"> 
    <td height="25"> <font size="1" face="Verdana, Arial, Helvetica, sans-serif"><strong>
    	<a href="event_search.asp">Tìm kiếm</a>&nbsp;|
		<a href="javascript: winpopup('event_addnew.asp','<%=CatId%>',420,300);">Sự kiện mới</a>
	</strong></font><font size="1" face="Verdana, Arial, Helvetica, sans-serif">&nbsp;</font></td>
  </tr>
</table>
<table width="770" border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="#000000" class=normal>
 <tr align="center" bgcolor="FFFFFF"> 
    ...
    <td align="right"><font size="2" face="Arial, Helvetica, sans-serif">
		...
		Tên sự kiện<a href="<%=sLink%>&FieldOrder=1&TypeOrder=0"><img src="../images/triangle-u.gif" width="16" height="16" border="0" align="absmiddle" title="Z->A"></a><a href="<%=sLink%>&FieldOrder=1&TypeOrder=1"><img src="../images/triangle-d.gif" width="16" height="16" border="0" align="absmiddle"title="A->Z"></a>&nbsp;| 
  ...
  <tr align="center" bgcolor="FFFFFF"> 
    <td valign="top"><%Call ListTreeCategory_WithRole(CatId, "Danh s&#225;ch chuy&#234;n m&#7909;c", "NONE", session("LstRole"), "ap", 4)%></td>
    <td valign="top" colspan="2"><%Call Display_News_Event(CatId,Page, FieldOrder,TypeOrder)%></td>
  </tr>
</table>
<%Call Footer()%>
</body>
